 ...
 */
static char *font = "FiraCode Nerd Font Mono:style=Regular:pixelsize=22:antialias=true:autohint=true, Noto Color Emoji:pixelsize=22:antialias=true:autohint=true";
